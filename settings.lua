...
data:extend(
{
  ...
  {type="double-setting",name="warptorio_going-home-chance",order="11b",
   ...
   minimum_value=0.00,maximum_value=1.0},
	...
	{type="double-setting",name="warptorio_quality-evolution",order="11b",
	setting_type="startup",default_value=0.95,
	...
	{type="bool-setting",name="warptorio_block-train-info-text",order="11b",
	setting_type="startup",default_value=false},
